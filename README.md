...
`Mesh` contains tile-local integer vertices and triangle indices. Its logical bounds provide the world-space origin and
axis-aligned culling volume. Presenters choose their own GPU vertex format, shading, materials, resource lifetime, and
occlusion strategy. Neither Qt nor Unreal Engine types cross this boundary.
